...
private:
    ...
    // --- 합성곱 층들 ---
    p2::convLayer      conv1;      p2::Adam conv1_opt;      p2::ActivateLayer conv1Act;
    p2::convLayer      conv2;      p2::Adam conv2_opt;      p2::ActivateLayer conv2Act;

    // --- 완전 연결(FC) 층들 ---
    p2::PerceptronLayer fc1;       p2::Adam fc1_opt;        p2::ActivateLayer fc1Act;
    p2::PerceptronLayer fc2;       p2::Adam fc2_opt;        p2::ActivateLayer fc2Act;
